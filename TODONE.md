...
- [x] [project:quine-tv] `traveldesk` (src/channels/traveldesk.js): street feed bug — CRT scanlines were only visible in the sky; now alternate dark+light scanlines so the effect reads across the whole inset. Commit: 6cef3ac
