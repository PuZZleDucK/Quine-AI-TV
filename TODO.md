...
- [ ] [project:quine-tv] visuals `containerport`: containers should be consistent persistant entities and not background elements or disapear, they should move with ships when loaded
